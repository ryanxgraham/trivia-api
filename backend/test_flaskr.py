...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_get_paginated_books(self):
        """Test paginate_questions functionality."""
    ...
    def test_404_beyond_valid_page(self):
        """Test 404 errorhandler for pages out of range."""
    ...
    def test_delete_question_success(self):
        """Test delete_question route - success."""
        test_question = Question(question=self.test_question['question'],
    ...
    def test_delete_question_fail(self):
        """Test delete_question route --fail."""
        test_question = Question(question=self.test_question['question'],
                                 answer=self.test_question['answer'],
                                 category=self.test_question['category'],
                                 difficulty=self.test_question['difficulty'])
    ...
    def test_create_question_success(self):
        """Test create_question route - success."""
    ...
    def test_create_question_fail(self):
        """Test create_question route - fail."""
    ...
    def test_question_search_with_results(self):
        """Test search route - results."""
        res = self.client().post('/questions/searchTerm', json={
                                'searchTerm': 'Tom'})
        data = json.loads(res.data)
    ...
    def test_get_question_by_category_success(self):
        """Test questions_by_category - success."""
    ...
    def test_get_question_by_category_fail(self):
        """Test questions_by_category - fail."""
